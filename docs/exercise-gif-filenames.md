...
| `bulgarian-split-squat.gif` | Болгарские выпады | ноги |
| `bicycle-crunches.gif` | Велосипед | кор |
| `stationary-bike.gif` | Велотренажёр | кардио |
| `hip-circles.gif` | Вращения таза | мобильность |
| `lunge-bicep-curl.gif` | Выпад + сгибание на бицепс | full_body |
| `forward-lunges.gif` | Выпады вперёд | ноги |
| `reverse-lunges-dumbbell.gif` | Выпады назад с гантелями | ноги |
...
| `seated-dumbbell-shoulder-press.gif` | Жим гантелей сидя | плечи |
| `close-grip-bench-press.gif` | Жим лёжа узким хватом | трицепс |
| `leg-press.gif` | Жим ногами | ноги |
| `bench-press.gif` | Жим штанги лёжа | грудь |
| `overhead-press.gif` | Жим штанги стоя | плечи |
...
| `toe-touch-stretch.gif` | Наклоны к носкам | мобильность |
| `reverse-lunge-with-twist.gif` | Обратные выпады с поворотом | full_body |
| `reverse-pec-deck.gif` | Обратные разведения в тренажёре | плечи |
| `dips.gif` | Отжимания на брусьях | грудь |
| `push-ups.gif` | Отжимания от пола | грудь |
| `incline-push-ups.gif` | Отжимания с возвышения | грудь |
| `knee-push-ups.gif` | Отжимания с колен | грудь |
| `close-grip-push-ups.gif` | Отжимания узким хватом | трицепс |
| `plank.gif` | Планка | кор |
| `plank-shoulder-taps.gif` | Планка с касанием плеч | full_body |
| `pull-ups.gif` | Подтягивания | спина |
| `front-dumbbell-raise.gif` | Подъёмы гантелей перед собой | плечи |
| `seated-calf-raise.gif` | Подъёмы на носки сидя | ноги |
| `standing-calf-raise.gif` | Подъёмы на носки стоя | ноги |
...
| `lateral-raise.gif` | Разводка гантелей в стороны | плечи |
| `overhead-triceps-extension.gif` | Разгибания гантели из-за головы | трицепс |
| `cable-triceps-pushdown.gif` | Разгибания на блоке | трицепс |
| `leg-extension.gif` | Разгибания ног | ноги |
| `wall-chest-opener.gif` | Раскрытие грудного отдела у стены | мобильность |
| `doorway-chest-stretch.gif` | Растяжка грудных у дверного проёма | мобильность |
| `piriformis-stretch.gif` | Растяжка грушевидной | мобильность |
| `hip-flexor-stretch.gif` | Растяжка сгибателей бедра | мобильность |
| `romanian-deadlift.gif` | Румынская тяга | ноги |
| `dumbbell-romanian-deadlift.gif` | Румынская тяга с гантелями | ноги |
| `russian-twists.gif` | Русские скручивания | кор |
| `cable-crossover.gif` | Сведение рук в кроссовере | грудь |
| `dumbbell-bicep-curl.gif` | Сгибания гантелей на бицепс | бицепс |
| `cable-bicep-curl.gif` | Сгибания на нижнем блоке | бицепс |
| `preacher-curl.gif` | Сгибания на скамье Скотта | бицепс |
| `lying-leg-curl.gif` | Сгибания ног лёжа | ноги |
| `barbell-bicep-curl.gif` | Сгибания со штангой | бицепс |
| `skater-jumps.gif` | Скейтер-прыжки | кардио |
