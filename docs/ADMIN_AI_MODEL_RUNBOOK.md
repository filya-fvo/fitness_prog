...
Вопросы о боли, времени отдыха между подходами и еде после тренировки не
передаются модели: приложение отвечает проверенными детерминированными правилами.
