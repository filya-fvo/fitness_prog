...
# The combined image serves the API and SPA from one HTTPS origin.
# VITE_* values are public build-time settings and must never contain secrets.
ARG VITE_SENTRY_DSN=""
ARG VITE_BOT_USERNAME=""
ARG VITE_NEW_USER_CHECKLIST_ENABLED="true"
ENV VITE_API_URL="" \
    VITE_SENTRY_DSN=$VITE_SENTRY_DSN \
    VITE_BOT_USERNAME=$VITE_BOT_USERNAME \
    VITE_NEW_USER_CHECKLIST_ENABLED=$VITE_NEW_USER_CHECKLIST_ENABLED
