...
const limits = {
  // Private and global regularity competitions remain isolated in one lazy
  // product route. Keep a narrow margin above the measured product total.
  totalJsGzip: 465_000,
  productJsGzip: 427_000,
