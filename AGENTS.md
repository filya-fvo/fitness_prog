...
- `backend/app/services/strength_trends.py` — ограниченные восьмью неделями
  серверные наборы «следующая тренировка», «лучшие изменения» и закреплённые;
  сравнение выполняется по нормализованному расчётному 1ПМ.
