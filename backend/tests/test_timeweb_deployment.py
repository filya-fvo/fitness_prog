...
def test_timeweb_environment_rejects_local_services_and_placeholders() -> None:
...
def test_timeweb_environment_accepts_managed_services() -> None:
    module = _load_script("validate_timeweb_env.py")
    errors = module.validation_errors(
        {
            "ENVIRONMENT": "production",
            ...
            "REDIS_URL": "rediss://fitness:encoded%40password@valkey.example:6380/0",
