...
NEW_ITEMS: list[dict] = [
    ...
    ex(
        ...
        tags=["gymvisual", "ds:2368", "curated", "bodyweight", "quads", "unilateral", "media:no-exact-gif"],
    ),
    ex(
    ...
    ex(
        ...
        "блок/кроссовер",
        2,
        "1. Установите канат на нижний блок и встаньте к тренажёру спиной.\n"
        "2. Проведите канат между ног, сделайте шаг вперёд и слегка согните колени.\n"
        "3. Отведите таз назад, сохраняя нейтральную спину и натяжение троса.\n"
        "4. Разогните таз усилием ягодиц и задней поверхности бедра.\n"
        "5. Руки держите пассивно; не превращайте движение в приседание.",
        description=(
            "Тяга с канатом между ног (cable pull-through) — тазодоминантное "
            "упражнение для ягодиц и задней поверхности бедра."
        ),
        animation_url=GIF_CABLE_PULL_THROUGH,
        common_mistakes=(
            "Глубокий присед вместо движения тазом; округление поясницы; тяга руками; "
            "чрезмерное отклонение корпуса назад."
        ),
        tags=["gymvisual", "ds:0196", "curated", "cable", "glutes", "hinge"],
    ),
    ex(
        ...
        "блок/кроссовер",
        2,
        "1. Закрепите манжету нижнего блока на голеностопе и встаньте лицом к стойке.\n"
        "2. Возьмитесь за опору, слегка согните опорную ногу и стабилизируйте таз.\n"
        "3. Отведите рабочую ногу назад за счёт разгибания бедра.\n"
        "4. Задержитесь на секунду и плавно верните ногу, не касаясь плитами стека.\n"
        "5. Выполните все повторения и смените сторону.",
        description=(
            "Отведение ноги назад в кроссовере — изолированное разгибание бедра "
            "с акцентом на ягодичные и минимальным движением в колене."
        ),
        animation_url=GIF_CABLE_HIP_EXTENSION,
        common_mistakes=(
            "Прогиб поясницы; разворот таза; мах по инерции; слишком большой вес; "
            "сильное сгибание опорного колена."
        ),
        tags=["gymvisual", "ds:0228", "curated", "cable", "glutes", "unilateral"],
    ),
    ex(
        ...
        "тренажёр",
        2,
        "1. Лягте грудью и животом на подушку тренажёра, таз разместите у края.\n"
        "2. Зафиксируйте корпус рукоятями и установите стопы в рабочий рычаг.\n"
        "3. Поднимите ноги разгибанием в тазобедренных суставах до линии корпуса.\n"
        "4. Сожмите ягодицы и подконтрольно опустите ноги.\n"
        "5. Сохраняйте поясницу нейтральной и не раскачивайтесь.",
        description=(
            "Обратная гиперэкстензия в тренажёре нагружает ягодицы и заднюю "
            "поверхность бедра без приседаний и выпадов."
        ),
        animation_url=GIF_REVERSE_HYPER,
        common_mistakes=(
            "Подъём ног выше линии корпуса; переразгибание поясницы; рывки; "
            "слишком большой вес и неконтролируемое опускание."
        ),
        tags=["gymvisual", "ds:0593", "curated", "machine", "glutes", "hinge"],
    ),
    ex(
        ...
        "гантели",
        2,
        "1. Лягте на спину, согните колени и устойчиво поставьте стопы.\n"
        "2. Положите гантель поперёк таза через мягкую накладку и удерживайте руками.\n"
        "3. Поднимите таз усилием ягодиц до прямой линии от колен до плеч.\n"
        "4. Задержитесь вверху и медленно опустите таз.\n"
        "5. Не переразгибайте поясницу и не перекатывайте гантель на живот.",
        description=(
            "Ягодичный мост с гантелью — нагружаемый вариант обычного моста, "
            "когда штанга или машина Смита недоступны."
        ),
        common_mistakes=(
            "Гантель без фиксации; толчок поясницей; отрыв носков или пяток; "
            "слишком далёкая постановка стоп."
        ),
        tags=[
            "ds:0339",
            "curated",
...
def patch_seed() -> list[str]:
    ...
    corrections = {
        ...
        "Удержание «лодочки»": {
            ...
            "technique": "1. Лягте на живот, вытяните руки вперёд, а ноги назад.\n2. Напрягите живот и ягодицы.\n3. Плавно приподнимите грудь, руки и ноги, не запрокидывая голову.\n4. Удерживайте положение указанное время и спокойно дышите.\n5. Опуститесь без рывка.",
            "tags": ["gymvisual", "ds:1014", "curated", "load:timed", "bodyweight", "media:no-exact-gif"],
        },
        "Птица-собака": {
            "description": "Попеременное вытяжение руки и противоположной ноги из положения на четвереньках.",
            "technique": "1. Встаньте на четвереньки: ладони под плечами, колени под тазом.\n2. Напрягите корпус и сохраняйте поясницу нейтральной.\n3. Одновременно вытяните вперёд одну руку и назад противоположную ногу.\n4. Задержитесь, вернитесь без поворота таза и смените сторону.",
            "tags": ["gymvisual", "ds:0464", "curated", "bodyweight", "media:no-exact-gif"],
        },
        "Высокие колени": {
            "description": "Бег на месте с контролируемым высоким подъёмом коленей.",
            "technique": "1. Встаньте прямо, стопы на ширине таза.\n2. Начните бег на месте и поочерёдно поднимайте колени к уровню таза.\n3. Приземляйтесь мягко на переднюю часть стопы.\n4. Держите корпус устойчиво и работайте руками в удобном темпе.",
            "tags": ["gymvisual", "ds:3636", "curated", "bodyweight", "media:no-exact-gif", "load:timed"],
        },
        "Присед + жим гантелей": {
            "equipment": "гантели",
            "description": "Приседание с последующим жимом гантелей над головой.",
            "technique": "1. Держите две гантели у плеч, стопы поставьте устойчиво.\n2. Опуститесь в присед, сохраняя корпус собранным.\n3. Поднимитесь усилием ног.\n4. После полного выпрямления выжмите гантели над головой.\n5. Верните гантели к плечам и повторите.",
            "tags": ["gymvisual", "ds:0550", "curated", "dumbbells", "full_body", "media:no-exact-gif"],
        },
        "Обратные выпады с поворотом": {
            "description": "Обратный выпад с контролируемым поворотом грудной клетки к передней ноге.",
            "technique": "1. Встаньте прямо и соберите корпус.\n2. Сделайте шаг назад и опуститесь в устойчивый выпад.\n3. Поверните грудную клетку в сторону передней ноги, не заваливая колено внутрь.\n4. Верните корпус в центр и оттолкнитесь передней ногой.\n5. Повторите другой ногой.",
        },
        "Кошка-корова": {
            "description": "Мягкое чередование сгибания и разгибания позвоночника на четвереньках.",
            "technique": "1. Встаньте на четвереньки, ладони под плечами, колени под тазом.\n2. На выдохе округлите спину и мягко направьте подбородок к груди.\n3. На вдохе плавно раскройте грудную клетку и слегка прогнитесь.\n4. Двигайтесь без боли и не запрокидывайте голову.",
            "tags": ["gymvisual", "ds:1363", "curated", "bodyweight", "media:no-exact-gif", "load:timed"],
        },
        "Мобилизация голеностопа": {
            "description": "Круговые движения голеностопом стоя с опорой на одну ногу.",
            "technique": "1. Встаньте рядом с устойчивой опорой и перенесите вес на одну ногу.\n2. Слегка приподнимите вторую стопу.\n3. Медленно выполните круги голеностопом в обе стороны.\n4. Сохраняйте колено и корпус неподвижными, затем смените ногу.",
        },
        "Мобилизация плеч с резинкой": {
            "description": "Контролируемое проведение лёгкой резинки над головой для подвижности плеч.",
            "technique": "1. Возьмите лёгкую резинку широким хватом перед собой.\n2. Слегка натяните её и проведите прямые руки над головой назад до комфортной амплитуды.\n3. Верните руки тем же путём.\n4. Не прогибайтесь в пояснице и остановитесь при боли.",
            "tags": ["gymvisual", "ds:1022", "curated", "bands", "media:no-exact-gif", "load:timed"],
        },
        "Поза голубя": {
            "description": "Растяжка ягодичных и наружных ротаторов бедра в позе голубя.",
            "technique": "1. Из положения на четвереньках выведите одно колено вперёд к одноимённой кисти.\n2. Разместите голень перед корпусом, вторую ногу вытяните назад.\n3. Выровняйте таз и опуститесь до комфортного натяжения.\n4. Не давите на колено; при дискомфорте уменьшите амплитуду.",
            "tags": ["gymvisual", "ds:2567", "curated", "bodyweight", "media:no-exact-gif", "load:timed"],
        },
        "Раскрытие грудного отдела у стены": {
            "description": "Поворот грудной клетки у стены с неподвижным тазом.",
            "technique": "1. Встаньте боком к стене в устойчивой стойке.\n2. Вытяните обе руки вперёд на уровне груди.\n3. Проведите дальнюю руку назад, разворачивая грудную клетку, а таз оставьте неподвижным.\n4. Вернитесь и выполните на другую сторону.",
            "tags": ["gymvisual", "ds:1167", "curated", "bodyweight", "media:no-exact-gif", "load:timed"],
        },
        "Растяжка грудных у дверного проёма": {
            "description": "Статическая растяжка грудных мышц с опорой предплечья о дверной проём.",
            "technique": "1. Поставьте предплечье на дверной проём, локоть примерно на уровне плеча.\n2. Сделайте небольшой шаг вперёд.\n3. Плавно поверните корпус от опоры до комфортного натяжения груди.\n4. Не поднимайте плечо и не допускайте боли.",
            "tags": ["gymvisual", "ds:1167", "curated", "bodyweight", "media:no-exact-gif", "load:timed"],
        },
        "Болгарские приседания без веса": {
            "animation_url": None,
            "thumbnail_url": None,
            "description": "Болгарские приседания с собственным весом и устойчивой задней опорой. Точного проверенного GIF пока нет.",
            "tags": ["gymvisual", "ds:2368", "curated", "bodyweight", "quads", "unilateral", "media:no-exact-gif"],
        },
    ...
    for row in rows:
        ...
        tags = [
            ...
            if tag != "media:verified" and not str(tag).startswith("media:reviewed:")
        ]
