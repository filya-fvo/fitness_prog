...
MANUAL: dict[str, list[str]] = {
    ...
    "приседания в машине смита": ["smith full squat", "smith squat"],
    "гакк-приседания": ["sled hack squat", "sled closer hack squat"],
    "болгарские приседания в машине смита": ["smith single leg split squat"],
    ...
    "жим лежа в машине смита": ["smith bench press"],
    "жим на наклонной в тренажере": ["lever incline chest press"],
    "сведение рук в тренажере бабочка": ["lever seated fly"],
    ...
    "тяга с упором грудью в тренажере": ["lever seated row", "lever high row"],
    "тяга верхнего блока нейтральным хватом": ["twin handle parallel grip lat pulldown", "cable lateral pulldown with v-bar"],
    ...
    "жим вверх в тренажере сидя": ["lever shoulder press"],
    "разводка гантелей в стороны": ["dumbbell lateral raise"],
    "отведение руки в сторону на блоке": ["cable lateral raise"],
    ...
    "сгибания гантелей на бицепс на наклонной скамье": ["dumbbell incline biceps curl"],
    ...
    "ягодичный мост": ["low glute bridge on floor"],
    "ягодичный мост со штангой": ["barbell glute bridge"],
    "ягодичный мост в машине смита": ["smith hip raise"],
    "сгибания ног сидя": ["lever seated leg curl"],
    "подъемы на носки стоя в тренажере": ["lever standing calf raise"],
    ...
    "скручивания на верхнем блоке": ["cable kneeling crunch"],
    "велосипед": ["air bike", "band bicycle crunch"],
    "русские скручивания": ["russian twist"],
    "жим паллофа с резинкой": ["band horizontal pallof press"],
