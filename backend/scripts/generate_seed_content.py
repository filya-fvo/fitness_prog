...
GROUPS: dict[str, list[tuple[str, str, int, str]]] = {
    "ноги": [
        ...
        ("Приседания гоблет", "dumbbells", 2, "home"),
        ...
        ("Хип-траст со штангой", "barbell", 3, "gym"),
    ...
    "кор": [
        ...
        ("Dead bug", "bodyweight", 1, "home"),
        ("Bird dog", "bodyweight", 1, "home"),
        ("Русские скручивания", "bodyweight", 2, "home"),
        ("Mountain climbers", "bodyweight", 2, "home"),
        ("Hollow hold", "bodyweight", 3, "home"),
    ],
    "кардио": [
        ("Бёрпи", "bodyweight", 3, "home"),
        ("Джампинг-джеки", "bodyweight", 1, "home"),
        ...
        ("Kettlebell swing", "kettlebell", 3, "gym"),
    ],
    "мобильность": [
        ...
        ("World greatest stretch", "bodyweight", 2, "home"),
    ...
    "full_body": [
        ("Трастеры с гантелями", "dumbbells", 3, "home"),
        ("Махи гирей", "kettlebell", 3, "gym"),
        ("Комплекс squat-to-press", "dumbbells", 2, "home"),
...
YT = {
    ...
    "Джампинг-джеки": "https://www.youtube.com/watch?v=iSSAk4XCsRA",
    ...
    "Хип-траст со штангой": "https://www.youtube.com/watch?v=LM8XHLYJoYs",
    ...
    "World greatest stretch": "https://www.youtube.com/watch?v=oNzynUF41kA",
