...
def home_female_c_bw(sets=3):
    return [
        ...
        ex("Планка", sets, "30-45с", 45),
        ex("Высокие колени", sets, "20-30с", 45),
    ]
...
def gym_female_beg_a(sets=3, reps="10-15", rest=70):
    return [
        ...
        ex("Тяга верхнего блока", sets, reps, rest),
        ex("Жим гантелей сидя", sets, reps, rest),
        ex("Разведение ног в тренажёре", sets, "12-20", 55),
...
def gym_female_beg_b(sets=3, reps="10-15", rest=70):
    return [
        ...
        ex("Сведение ног в тренажёре", sets, "12-20", 55),
    ]
...
def gym_female_int_lower_glute(sets=4, reps="8-12", rest=80):
    return [
        ...
        ex("Разведение ног в тренажёре", 3, "12-20", 55),
...
def home_no_knee_bw_b():
    return [
        ...
        ex("Боковая планка", 3, "15-30с", 40),
        ex("Мёртвый жук", 3, "8/стор", 40),
        ex("Подъёмы на носки без веса", 3, "15-20", 40),
    ]
...
def shoulder_home_male(sets=3, reps="10-15", rest=60):
    return [
        [
            ...
            ex("Подъёмы на носки без веса", sets, "15-20", 45),
...
def adjusted_for_level(items: list[dict], level: str) -> list[dict]:
    ...
    return [
        {
            **item,
            "sets": max(int(item["sets"]), 4) if index < 2 else max(int(item["sets"]), 3),
    ...
    add_pair(
        ...
        schedule=[
            ...
            day(2, "Низ A", "lower", [
                ...
                ex("Сведение ног в тренажёре", 3, "12-20", 60),
            ...
            day(4, "Низ B", "lower", [
                ...
                ex("Сгибания ног лёжа", 3, "10-15", 75),
                ex("Разведение ног в тренажёре", 3, "12-20", 60),
    ...
    programs.append(prog(
        ...
        schedule=[
            ...
            day(4, "Lower B", "lower", [
                ...
                ex("Сведение ног в тренажёре", 3, "12-20", 55),
                ex("Подъёмы на носки сидя", 3, "12-15", 40),
                ex("Планка", 3, "30-45с", 40),
            ]),
        ],
